...
async function fetchWeatherData() {
  ...
  fetchBtn.innerHTML = '<span class="loader loader-btn"></span>';
  ...
  try {
    ...
    if (result.ok) {
      ...
      weatherDataElement.innerHTML = "Server is not ready";
    }
  } catch (error) {
...
function showWeatherData(weatherData) {
  ...
  divMain.style.gridTemplateColumns = `repeat(${
    1 + weatherData.daily.time.length
  }, 1fr)`;
